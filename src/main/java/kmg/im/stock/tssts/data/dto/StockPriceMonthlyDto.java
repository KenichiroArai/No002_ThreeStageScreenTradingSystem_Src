...
public class StockPriceMonthlyDto {
     ...
     *                         月開始日付
     */
    public void setMonthlyStartDate(final LocalDate monthlyStartDate) {
    ...
    public LocalDate getMonthlyStartDate() {
        final LocalDate result = this.monthlyStartDate;
        return result;
    }
     ...
     *                       月終了日付
     */
    public void setMonthlyEndDate(final LocalDate monthlyEndDate) {
    ...
    public LocalDate getMonthlyEndDate() {
        final LocalDate result = this.monthlyEndDate;
        return result;
    }
